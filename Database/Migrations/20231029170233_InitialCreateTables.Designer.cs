...
namespace Database.Migrations
{
    ...
    [Migration("20231029170233_InitialCreateTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FileDbTokenDb", b =>
                {
                    ...
                    b.Property<Guid>("TokensTokenName")
                        .HasColumnType("uuid");

                    b.HasKey("FilesId", "TokensId", "TokensTokenName");

                    b.HasIndex("TokensId", "TokensTokenName");

                    b.ToTable("FileDbTokenDb");
                });
            ...
            modelBuilder.Entity("FileDbTokenDb", b =>
                {
                    ...
                    b.HasOne("Database.Entities.TokenDb", null)
                        .WithMany()
                        .HasForeignKey("TokensId", "TokensTokenName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
